...
CONFIG.MusicVolume=100;   --音乐音量         
CONFIG.SoundVolume=50;  --音效音量
...
CONFIG.Width  = 800;       -- 游戏图形窗口宽
CONFIG.Height = 600;      -- 游戏图形窗口宽
...
CONFIG.JYMain_Lua=CONFIG.ScriptPath .."CY_Main.lua";   --lua主程序名

--显示字体文件。如果是windows，可直接给出系统目录下的字体名。
--其他系统可以找个合适的truetype字体复制到游戏data或其他目录下，在这里给出路径和文件名
--CONFIG.FontName="f:/font/方正华隶简体.ttf";
--CONFIG.FontName="c:/windows/fonts/simfang.TTF";
--CONFIG.FontName="c:/windows/fonts/simsun.TTC";
--CONFIG.FontName="c:/windows/fonts/经典楷体简.ttf"; --SIMKAI.ttc";
--CONFIG.FontName="e:/幕舍/经典楷体简.TTF"; 
